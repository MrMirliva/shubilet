...
/**
    ...
    Provides centralized factory methods for constructing standardized error message payloads
    used across the authentication and session-management layers. This utility class ensures
    consistency in how error responses are generated by mapping common validation, session,
    and authentication failure scenarios to predefined message templates. As a final utility
    class, it enforces non-instantiability and exposes only static helpers for error creation.
    ...
    <p>
        ...
        <ul>
            <li>Core Java utility patterns</li>
            <li>DTO-based error response construction</li>
        </ul>
