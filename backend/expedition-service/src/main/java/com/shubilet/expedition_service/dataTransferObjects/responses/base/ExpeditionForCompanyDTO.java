...
public class ExpeditionForCompanyDTO {
    ...
    public ExpeditionForCompanyDTO(
        ...
        this.expeditionId = (expeditionId != null) ? expeditionId : -1;
        this.departureCity = departureCity;
        this.arrivalCity = arrivalCity;
        ...
        this.numberOfBookedSeats = (numberOfBookedSeats != null) ? numberOfBookedSeats : 0;
        this.profit = (profit != null) ? profit.doubleValue() : 0.0;
    }
