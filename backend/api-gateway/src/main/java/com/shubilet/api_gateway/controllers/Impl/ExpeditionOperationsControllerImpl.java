...
public class ExpeditionOperationsControllerImpl implements ExpeditionOperationsController {
    ...
    public ResponseEntity<ExpeditionSearchResultsCompanyDTO> sendExpeditions(HttpSession httpSession, @RequestBody ExpeditionSearchDTO expeditionSearchDTO) {
        ...
        logger.info("Before Mapping Expedition Company ID{}", expeditionServiceSearchExpeditionResponse.getBody().getExpeditions().getFirst().getCompanyId());
        ...
        logger.info("After Mapping Expedition Company ID{}", companyIdDTOs.getFirst().getCompanyId());
    ...
    @Override
    public ResponseEntity<ExpeditionsForCompanyDTO> getCompanyExpeditions(HttpSession httpSession) {
        String requestId = UUID.randomUUID().toString();
